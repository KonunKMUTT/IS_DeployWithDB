...
def main():
    ...
    st.warning('Disclaimer : The predictions generated by this system are solely for diagnostic purposes and are based on simulated datasets created for the study of machine learning processes. They do not constitute medical advice, cannot replace individual medical judgment, and should not be used as a substitute for professional medical consultation, diagnosis, or treatment.', icon="⚠️")
