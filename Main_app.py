...
def main():
    ...
    st.markdown('<p style="text-align:center; color:orange; font-size:20px;">This program This program was developed as a master\'s degree research project under the DBIS Program of School of Information Technology, King Mongkut\'s University.</p>',unsafe_allow_html=True)
