...
def main():
    ...
    st.markdown('<p style="text-align:center; color:orange;">This program is a master\'s thesis project in the DBIS program, School of Information Technology, King Mongkut\'s University.</p>',unsafe_allow_html=True)
