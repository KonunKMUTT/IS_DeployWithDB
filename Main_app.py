...
def main():
    ...
    st.markdown('<p style="text-align:center; color:orange; font-size:11px;">This program was developed as a master\'s degree research project under the DBIS Program of School of Information Technology,King Mongkut\'s University of Technology Thonburi - KMUTT.</p>',unsafe_allow_html=True)
