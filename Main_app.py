...
def main():
    ...
    st.markdown('<p style="text-align:center; font-weight:bold; font-size:20px">Enter the data to prediction, Please Ensure all feilds are filled.</p><br>', unsafe_allow_html=True)
